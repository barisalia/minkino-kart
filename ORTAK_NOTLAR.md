...
- 2026-09-26 KARAR (Barış): Mino gövde gölgesi onaylandı (tasarımcı, ekip/illustrator/mino-golge.jsx; önizleme ekip/mino/mino-golge-*.png). Tasarımcı katmanlara ayırmaya (kuyruk, govde, kol-sol, kol-sag, fular, kafa, goz-sol, goz-sag, agiz) ve gizli goz-kapali/agiz-acik/agiz-kapali katmanlarına geçti.
- 2026-09-26 TESLİM (tasarımcı): Mino'nun son hâli hazır: `ekip/mino/mino-final.svg` (2048×2048; Presentation Attributes, id = katman adı, minify kapalı) + `ekip/mino/mino-final.png` (2048 px, şeffaf). Katmanlar arkadan öne: kuyruk, govde, kol-sol, kol-sag, fular, kafa, goz-sol, goz-sag, agiz; gizli (`display="none"`): goz-kapali, agiz-acik, agiz-kapali. Her katmanın kendi dış konturu var; gövdede kafanın altına uzanan boyun var (kafa 12°, kollar 25°, kuyruk 15° döndürülerek boşluk yok diye denendi). Duruşta gölgeli tek parça hâliyle aynı (yalnız kenar yumuşatma farkı). Betikler: `ekip/illustrator/mino-*.jsx`. Kollar Barış'ın isteğiyle yenilendi: kol ve pati her kenarda eşit 13 px kendi konturunu taşıyor; kalkınca iç kenarda da çizgi var, omuzda çentik ve kıymık yok.
- 2026-09-26 TAMAM: Yeni Mino oyunlara bağlandı (kodcu): scripts/mino/rig.mjs katman gruplarından src/mino/mino-svg.ts üretir; kollar ayrı oynar (zıpla, dans, el sallama, gerinme; üst sınır 24°), göz kırpma/uyku goz-kapali katmanıyla, ağız kodla (koyu kahve). Kart oyunu Mino ekranı, açılış düğmesi (assets/karakter/mino.webp), Sesli Maceralar avatarı güncellendi. build + 101 birim + e2e (mino, macera, akis, pazar) geçti. KALAN İŞ: Pazar hâlâ eski kedi-3.webp kullanıyor (oyun beklemede).
