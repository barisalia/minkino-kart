...
- 2026-09-26 DÜZELTME: Sesli Maceralar kendi kendine ilerliyordu (Barış). Sebep: e0e8e1b 'kolay üfleme' kuralı yüksek her sesi (konuşma, müzik, oyunun kendi müziği) üfleme sayıyordu. Kolay mod artık gürültü benzeri spektrum + kalın ağırlık + perdesizlik şartı arıyor (eşikler analiz.ts KOLAY sabitinde); mikrofon dinlerken arka plan müziği susuyor; konuşmadan sonra 350 ms dinlenmiyor; pasta kesme hışırtısında kulak.sustur. Birim testleri: konuşma/müzik sayılmaz, üfleme ve 'fuuu' sayılır. ONAY BEKLİYOR: saklan-sus adımında 'Kim var orada?' konuşması sırasında da sessizlik süresi işliyor; durdurulsun mu? Sürpriz adımı tür bakmadan yüksek sesle geçiyor (tasarım kararı). KALAN İŞ: gerçek cihazda /ses-testi/ raporlarıyla eşik ayarı.
