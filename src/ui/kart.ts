...
const gorseller = import.meta.glob<string>(['../../assets/**/*.webp', '!../../assets/karakter/**', '!../../assets/sahne/**', '!../../assets/orman/**', '!../../assets/orman-karakter/**', '!../../assets/orman-esya/**', '../../assets/karakter/kedi-3.webp'], {
  eager: true,
  query: '?url',
  import: 'default',
});
